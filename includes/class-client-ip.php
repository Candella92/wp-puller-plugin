<?php
/**
 * Client IP resolver for WP Puller Plugin.
 *
...
/**
 * WPP_Plugin_Client_IP Class.
 */
class WPP_Plugin_Client_IP {

	const CF_CACHE_KEY = 'wpp_plugin_cloudflare_ips';
	...
	private static function trusted_ranges() {
		...
		return apply_filters( 'wpp_plugin_trusted_proxies', $ranges );
	}
	...
	/**
	 * Fetch current Cloudflare ranges from cloudflare.com.
	 *
	 * @return string[]
	 */
	...
	/**
	 * Hard-coded fallback Cloudflare ranges.
	 *
	 * @return string[]
	 */
	...
	/**
	 * Check if $ip is inside any of the given CIDR ranges.
	 *
	 * @param string   $ip     IP address.
